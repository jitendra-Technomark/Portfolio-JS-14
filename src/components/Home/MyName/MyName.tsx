  ...
  return (
    <div className='flex h-full flex-col justify-center px-8 py-32 sm:px-8 sm:py-52 md:px-28 lg:px-32 xl:px-56 2xl:px-72'>
      ...
      >
        ...
        <span className='text-AAsecondary'>React.js</span>, <span className='text-AAsecondary'>Node.js</span>, and more. I excel
        in problem-solving and take pride in crafting outstanding web experiences. <br className='block' />
        <br className='block' />
